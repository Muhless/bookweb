        ...
        <div className="cover flex justify-center items-center rounded-xl">
          <div className="p-10">
            ...
            <div className="flex items-center">
              <Image src={Author3} />
              <p className="ml-2">
                <span className="font-semibold">John Lucas</span> - 5 days ago
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="cover flex justify-center items-center rounded-xl">
          <div className="p-10">
            ...
            <div className="flex items-center">
              <Image src={Author2} />
              <p className="ml-2">
                <span className="font-semibold">Ade Barkah</span> - 6 month ago
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="cover flex justify-center items-center rounded-xl">
          <div className="p-10">
            ...
            <div className="flex items-center">
              <Image src={Author3} />
              <p className="ml-2">
                <span className="font-semibold">John Lucas</span> - 3 month ago
              </p>
            </div>
          </div>
        </div>
